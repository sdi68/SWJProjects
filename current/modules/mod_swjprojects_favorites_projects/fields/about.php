...
class JFormFieldAbout extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        if ((new Version())->isCompatible('4.0')) {
            ...
            $wr = $wa->getRegistry();
            $wr->addRegistryFile('/media/mod_swjprojects_favorites_projects/joomla.assets.json');
            $wa->useScript('mod_swjprojects_favorites_projects.back');
            $wa->useStyle('mod_swjprojects_favorites_projects.back');
            $wa->useStyle('mod_swjprojects_favorites_projects.about');
        } else {
            ...
            $doc->addStyleSheet('/media/mod_swjprojects_favorites_projects/css/about.css');
        }

        if (empty($this->ext_image) || !file_exists($this->ext_image)) {
            $this->ext_image = '/media/mod_swjprojects_favorites_projects/img/logo.png';
        }
        ...
        $html .= ('<img src = "/media/mod_swjprojects_favorites_projects/img/logo.png"/>');
        $html .= "</div>";
