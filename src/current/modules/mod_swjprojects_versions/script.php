...
if (!class_exists('mod_swjprojects_versionsInstallerScript'))
{
	class mod_swjprojects_versionsInstallerScript
	{
		...
		public function postflight($type, $parent)
		{
            ...
            <h3>The module mod_swjprojets_versions v2.0.1 Changelog</h3>
