...
if (!class_exists('mod_swjprojects_projectsInstallerScript'))
{
	class mod_swjprojects_projectsInstallerScript
	{
		...
		public function postflight($type, $parent)
		{
            ...
            <h3>The module mod_swjprojets_projects v2.0.1 Changelog</h3>
