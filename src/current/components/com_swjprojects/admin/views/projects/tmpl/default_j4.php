				...
				<?php else : ?>
                    <table id="projectsList" class="table itemList">
                        ...
                        <tr>
                            ...
                            <th scope="col">
								<?php echo Text::_("COM_SWJPROJECTS_BASE_PROJECT") ?>
                            </th>
						...
						<?php foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1">
                                ...
                                <td class="d-none d-md-table-cell">
									<?php
									$bp_link = ($canEdit && $item->base_project_id) ? Route::_('index.php?option=com_swjprojects&task=project.edit&id='
										. $item->base_project_id) : '';
									if ($bp_link):
										?>
                                        <a <?php echo ($bp_link) ? 'href="' . $bp_link . '"' : 'disable'; ?>>
                                            <div class="text-nowrap">
                                                <strong><?php echo $item->base_project; ?></strong>
                                            </div>
                                        </a>
									<?php else: ?>
                                        <div class="text-nowrap">
