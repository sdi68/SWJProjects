...
if (!class_exists('plgSystemSWJPaymentInstallerScript'))
{
	/**
	 * SWJPayment plugin script file.
	 *
	 * @package     pkg_swjprojects_payment
	 * @subpackage  system/swjpayment
	 * @since       1.0.0
	 */
	class plgSystemSWJPaymentInstallerScript
	{
		public function preflight($type, $parent)
		{
			...
			{
				$app->enqueueMessage('The plugin requires an installed com_swjprojects to work! Install please this before!', 'error');
		...
		public function postflight($type, $parent)
		{
            ...
            <a class="btn btn-primary btn-large"
               href="<?php echo Route::_('index.php?option=com_plugins&task=plugin.edit&extension_id=' . $pluginId); ?>">Start
                using the system plugin SWJPayment v1.0.0.</a>
		<?php } ?>
			<?php if (0): ?>
		...
		protected function runSQL($source, $file): void
		{
			$db     = Factory::getDbo();
