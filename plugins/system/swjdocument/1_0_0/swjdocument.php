...
class PlgSystemSWJDocument extends SWJPaymentPlugin
{
	...
	/**
	 * Обработчик события получения альтернативного документа.
	 * Получаем из pdf файла.
	 *
	 * @param   string  $context  Контекст вызова события
	 * @param   object  $item     Документ из компонента
	 * @param   string  $html     Альтернативное представление документа
	 *
	 * @return bool
	 *
	 * @throws Exception
	 * @since 1.0.0
	 */
	public function onGetAlternativeDocument(string $context, object $item, string &$html): bool
	{
		switch (true)
		{
	 ...
	 *
	 * @param   string  $context  Контекст отображения формы
	 * @param           $data
	 *
	 * @return bool
	 *
	...
	/**
	 * Обработчик события после сохранения документа
	 *
	 * @param   string  $context  Контекст вызова события
	 * @param   Table   $table    Таблица документа
	 * @param   bool    $isNew    Флаг новой записи
	...
	/**
	 * Обработчик события после удаления документа
	 *
	 * @param   string  $context  Контекст вызова события
	 * @param   Table   $table    Таблица документа
	 *
